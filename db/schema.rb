...
ActiveRecord::Schema[7.0].define(version: 2024_02_03_225702) do
  ...
  create_table "product_categories_suppliers", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "supplier_list_products", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "supplier_id"
    t.bigint "product_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_supplier_list_products_on_product_id"
    t.index ["supplier_id"], name: "index_supplier_list_products_on_supplier_id"
  end
